...
TRANSLATIONS = {
    "fr": {
        ...
        "admin.product.weight_options_title": "Prix par poids",
        "admin.product.weight_options_hint": "Exemple : 100 g avec son prix, puis 200 g avec son prix.",
        "admin.product.weight_label_placeholder": "Poids : 100 g",
        "admin.product.weight_price_placeholder": "Prix : 15 DH",
        "admin.product.add_weight_option": "Ajouter une ligne",
        ...
        "flash.product_price_or_weight_required": "Mettez un prix, ou ajoutez au moins un poids avec son prix.",
        ...
        "validation.weight_options_invalid": "Chaque ligne doit avoir un poids et un prix.",
        "validation.weight_options_duplicate": "Ce poids existe deja pour ce produit.",
    ...
    "ar": {
        ...
        "home.product.weight_select": "اختر الوزن",
        ...
        "admin.product.weight_options_title": "السعر حسب الوزن",
        "admin.product.weight_options_hint": "مثال: 100 g مع سعره، ثم 200 g مع سعره.",
        "admin.product.weight_label_placeholder": "الوزن: 100 g",
        "admin.product.weight_price_placeholder": "السعر: 15 DH",
        "admin.product.add_weight_option": "إضافة سطر",
        "admin.product.remove_weight_option": "حذف",
        ...
        "flash.product_price_or_weight_required": "ضع سعراً، أو أضف وزناً واحداً على الأقل مع سعره.",
        ...
        "validation.weight_options_invalid": "كل سطر يجب أن يحتوي على وزن وسعر.",
        "validation.weight_options_duplicate": "هذا الوزن موجود بالفعل لهذا المنتج.",
